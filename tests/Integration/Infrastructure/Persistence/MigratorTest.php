...
final class MigratorTest extends TestCase
{
    ...
    public function testItAppliesTheMetadataSchemaToAnEmptyDatabase(): void
    {
        ...
        self::assertSame(
            ['001_initial_metadata', '002_capability_snapshots', '003_print_submission_idempotency'],
            $migrator->migrate(),
        );
        ...
        self::assertContains('print_submission_keys', $tables);
    ...
    public function testItRollsBackTheLatestMigrationTransactionally(): void
    {
        ...
        self::assertSame('003_print_submission_idempotency', $migrator->rollbackLast());
        self::assertFalse($this
            ->query("SELECT name FROM sqlite_master WHERE type = 'table' AND name = 'print_submission_keys'")
            ->fetchColumn());
